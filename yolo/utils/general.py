...
def build_targets(p, targets, model):
    ...
    for i, jj in enumerate(model.module.yolo_layers if multi_gpu else model.yolo_layers):
        ...
        anchors = model.module.module_list[jj].anchor_vec.to(targets.device) if multi_gpu else model.module_list[jj].anchor_vec
...
def plot_images(images, targets, paths=None, fname=None, names=None, max_size=640, max_subplots=16, conf_thresh=0.3):
    tl = 3  # line thickness
    tf = max(tl - 1, 1)  # font thickness
